import 'package:expense_pro/core/components/bottom_dialog/remove_budget_dialog.dart';
...
import 'package:expense_pro/core/components/icons/shopping_icon.dart';
import 'package:expense_pro/core/components/icons/trash_icon.dart';
import 'package:expense_pro/core/components/icons/warning_icon.dart';
import 'package:expense_pro/domain/models/budget.dart';

import 'package:expense_pro/screens/budget/budget_edit_page.dart';
...
class _BudgetDetailPageState extends State<BudgetDetailPage> {
  ...
  late final double percent = widget.budget.spent / widget.budget.limit;
  void _confirmation() {}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          AppLocalizations.of(context)?.detailBudget ?? AppText.detailBudget,
          ...
          IconButton(
            onPressed: () async {
              await showModalBottomSheet(
                ...
                context: context,
                // showDragHandle: true,
                builder: (context) => RemoveBudgetDialog(confirmation: _confirmation),
              );
            },
            icon: const Icon(
              TrashIcon.trash,
      ...
      body: Column(
        ...
        children: [
          ...
          Text(
            AppLocalizations.of(context)?.remaining ?? AppText.remaining,
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  AppLocalizations.of(context)?.exceedLimit ?? AppText.exceedLimit,
