  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title: Text(
          AppLocalizations.of(context)?.signUp ?? AppText.signUp,
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: PrimaryButton(
                text: AppLocalizations.of(context)?.signUp ?? AppText.signUp,
                onPressed: () {},
              ),
            ),
            Text(
              AppLocalizations.of(context)?.orWith ?? AppText.orWith,
